      ...
      <div className="results">
        {results.length > 1 ? (
          ...
          <div className="results__wrapper">
            <div>
              <p>dari hasil analisa saya, anda adalah seorang {mapExpressionToEmosi(results[0].gender)} dan saya rasa emosi anda sekarang adalah mapExpressionToEmosi(results[0].expressions.asSortedArray()[0].expression)}</p>
            </div>
