      ...
      <div className="results">
        {results.length > 1 ? (
            ...
            {results.map((result, i) => (
              <div className="results__wrapper" key={i}>
                <div style={{ width: '300px' }}>
                  <p>
                    saya rasa salah satu dari kalian adalah seorang {mapExpressionToEmosi(results[0].gender)} dan sedang {mapExpressionToEmosi(result.expressions.asSortedArray()[0].expression)}
                  </p>
                </div>
          ...
          <div className="results__wrapper">
            <div>
              <p>dari hasil analisa saya, anda adalah seorang {mapExpressionToEmosi(results[0].gender)}</p>
              <p>dan saya rasa emosi anda sekarang adalah {mapExpressionToEmosi(results[0].expressions.asSortedArray()[0].expression)}</p>
            </div>
